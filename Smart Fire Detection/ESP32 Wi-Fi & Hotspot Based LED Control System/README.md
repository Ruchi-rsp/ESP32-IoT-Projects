...
Overview
This project enables wireless control of an LED using ESP32 through a smartphone. 
The system works in both Wi-Fi Station mode (connected to external Wi-Fi) and
Access Point mode (ESP32 hotspot), ensuring flexible control with or without internet.
